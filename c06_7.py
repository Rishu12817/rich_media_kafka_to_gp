...
import uuid
# Define the possible event codes
event_codes = ["right", "left", "swipe_up", "swipe_down"]

# Function to randomly select an event code
                ...
                dummy_data = [
                    {
                        ...
                        'DeviceTypeId': '4',
                        'Custom_DeviceCapabilityIds': ['cap1', 'cap2'],
                        'CountryId': '1',
                        'RegionId': '2',
                        'CityId': '3',
                        'MobileOperatorId': '1',
                        ...
                        'Age': '30',
                        'U_Age': '30',
                        'CustomParameters': 'param1=value1,param2=value2',
                        'EnvironmentType': 0,
                        'DeviceOrientationId': '1',
                        'AdResponseFormatId': '1',
                        'BlackBerryVendorId': '1234',
                        'LanguageId': '1',
                        'RequestVersion': '1',
                        'IP': '192.168.1.1',
                        'ClientServerIP': '192.168.1.2',
                        'CampaignType': 0,
                        'HttpRefererId': 'referer123',
                        'IsWiFi': 'True',
                        ...
                        'FraudErrorCode': 16,
                        'XForwardedFor': '',
                        'PartnerRefId': 'partner123',
                        'ChannelId': '1',
                        'HostIP': '172.22.112.108',
                        'HostName': 'DESKTOP-MDKCIE7',
                        'StatColumnName': 'column1',
                        'CreativeUnitIds': ['123', '456'],
                        'Demand_MappingId': '789',
                        'Deals_AdCreativeUnits': [
                            {'key': 'deal1', 'value': 'value1'},
                            {'key': 'deal2', 'value': 'value2'}
                        ],
                        'RTBSourceTID': 'rtbsource123',
                        'PartnerImpTagId': 'partnerimp123',
                        'BidFloor': 0.5,
                        'metadata': {
                            'adcreativeunitsdata': [
                                {
                        ...
                        'AudienceSegmentDataBillSummary': '',
                        'VideoData': {
                            'MinDuration': '30',
                            'MaxDuration': '120',
                            'Width': '1920',
                            ...
                            'IsRewarded': 'True',
                            'PlacementTypeId': '1',
                            'InStreamPositionId': '1',
                            'SkippableAdOptionIds': '1',
                            'PlaybackMethodId': '1',
                            'SupportEndCard': 'True',
                            'CompanionTypes': '1'
                        },
                        'NativeData': {
                            'IconWidth': '48',
                            'IconHeight': '48',
                            'IsLargerIconAllowed': 'True',
                            'IsIconMandatory': 'True',
                            'IconMIMETypeIds': '1',
                            'ImageWidth': '1080',
                            'ImageHeight': '720',
                            'IsLargerImageAllowed': 'True',
                            ...
                            'ActionTextMaxLength': '30',
                            'IsActionTextMandatory': 'True',
                            'IsRatingMandatory': 'True',
                            'SponsoredMaxLength': '20',
                            'IsSponsoredMandatory': 'True'
                        },
                        'PartnerSDK': 'SDKv1',
                        'PartnerSDKVersion': '1.0.0',
                        'TrackUser': 'usertrack1',
                        'adcreativeunitsformat': [{'key': 1, 'value': 1}],
                        'IsInterstitial': 'False',
                        'IsBillable': 'False',
                        'PartnerUserId': 'partneruser123',
                        'PartnerBuyerUserId': 'partnerbuyer123',
                        'AuctionType': 0,
                        'ImpressionMetrics': ['metric1'],
                        'Trace': 'trace1',
                        'SubPublisherData': '',
                        'SSPPartnerId': '',
                        'BillingMetaData': '',
                        ...
                        'UserAliasId': 'alias123',
                        'OperatorDetectedByMNC': 'False',
                        'ExternalDSPs': [],
                        'IsExternalDSPRequested': 'False',
                        'DeviceId': 'device123',
                        'PartnerCampaignIds': ['campaign1', 'campaign2'],
                        ...
                        'ProvidersSegments': ['segment1'],
                        'SponsoredAdData': {'ad1': 'sponsored1'},
                        'AdCreativeIds_SearchKeywordIds': ['keyword1'],
                        'BiddingData': {'bid1': 0.1}
                    }
                ]


                # Append to batch_data
                batch_data.append(dummy_data[0])
