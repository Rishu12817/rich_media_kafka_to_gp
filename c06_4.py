...
try:
    for message in consumer:
        try:
            ...
            print(type(data["Version"]))  # Should print <class 'int'>
            # Explicitly convert fields to correct types
            data["Version"] = int(data["Version"])  # Ensure it's an integer
            data["Id"] = int(data["Id"])  # Ensure it's an integer
