...
dag = DAG(
    'RichmediaHdfsToGreenPlum_logs',
    default_args=default_args,
    description='Adfalcon Rich media delivery data reading from kafka topic richmedia_ingest_logs filtered data from HDFS to GP table fact_stat_custumevent_h --> Airflow logs',
    schedule_interval=timedelta(hours=1),
)

t1 = PythonOperator(
    task_id='RichmediaHdfsToGreenPlum',
    python_callable=RichmediaHdfsToGreenPlum,
    dag=dag,
)