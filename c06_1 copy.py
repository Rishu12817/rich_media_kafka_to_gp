...
group_id = 'richmedia_ingest_logs_test_consumer_group'
...
try:
    for message in consumer:
        try:
            ...
            data = [(Id, Time, Time, AdId, AppSiteId, SubAppSiteId, DeviceBrandId, RequestId, HostIP, ip_2, HostName, event_name)]
