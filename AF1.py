...
dag = DAG(
    'RichmediaKafkatoHdfs_logs',
    default_args=default_args,
    description='Adfalcon Rich media delivery data reading from kafka topic richmedia_ingest_logs filtering it and writting to HDFS --> Airflow logs',
    schedule_interval=timedelta(hours=1),
)

t1 = PythonOperator(
    task_id='RichmediaKafkatoHdfs',
    python_callable=RichmediaKafkatoHdfs,
    dag=dag,
)